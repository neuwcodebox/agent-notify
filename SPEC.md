...
채널 이름은 고정 목록이 아니며 사용자가 설정 파일에서 자유롭게 정한다. 문서의 `personal`, `team`, `phone`, `local`, `automation` 같은 이름은 예시일 뿐이다.
...
# inline 값을 직접 쓸 수도 있다.
# bot_token = "123456:ABC..."
# chat_id = "123456789"

# 선택. 기본값은 "plain".
# 지원 값: "plain", "html", "markdown-v2"
# parse_mode = "plain"
```
...
# 기본값은 false. true로 설정하면 Discord mention을 허용한다.
...
# inline topic을 직접 쓸 수도 있다.
# topic = "my-topic"

# 선택. 기본값은 "https://ntfy.sh".
# server = "https://ntfy.sh"

# 선택. ntfy server/topic 설정에 따라 필요할 수 있다.
...
# 기본값은 false. true로 설정하면 Slack mass mention을 허용한다.
# allow_mentions = false
```
...
# inline token을 직접 쓸 수도 있다.
# token = "app-token"

# 선택. 메시지 priority 매핑보다 우선한다.
# priority = 5
```
...
# inline URL을 직접 쓸 수도 있다.
# url = "https://example.com/notify"

# 선택. Authorization 헤더로 그대로 전송된다.
